...
class Doxygen extends \Peg\Parse\Extractor 
{
	...
	public function Start($path)
	{
		...
		$this->SaveDefinitions(Application::GetCwd() . "/json", DefinitionsType::CLASSES);
		$this->SaveDefinitions(Application::GetCwd() . "/json", DefinitionsType::CLASS_ENUMERATIONS);
		$this->SaveDefinitions(Application::GetCwd() . "/json", DefinitionsType::CLASS_VARIABLES);
