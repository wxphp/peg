...
<? } ?>
	...
	{
		function_called = <?=$extension?>_call_method((zval**) &this->phpObj, NULL, &cached_function, "<?=$method_name?>", <?=strlen($method_name)?>, &return_value, <?=count($method_definition["parameters_type"])?>, params TSRMLS_CC);
	}
	else
	{
